...
You can tell RabbitMQ is installed by checking if the tcp/ip port 5672 is
opened. For example if you have installed RabbitMQ you should see something like:
